/**
 * @codespar/llama-index basic tests for 0.2.0.
 */

import { describe, it, expect } from "vitest";
import type { Session, Tool, ToolResult } from "@codespar/sdk";
import { toLlamaIndexTool, getTools, handleToolCall } from "../index.js";
...
describe("@codespar/llama-index", () => {
  it("toLlamaIndexTool creates tool with correct shape", () => {
    const session = fakeSession([makeTool()]);
    const tool = toLlamaIndexTool(makeTool(), session);
