...
import { SERVICE_INVOICE_SCENARIO } from "@codespar/types/testing";
...
describe("aimock fixtures stay in sync with the published scenario", () => {
  it("static fixtures equal SERVICE_INVOICE_SCENARIO.aimockFixtures", () => {
    expect(staticFixtures).toEqual(SERVICE_INVOICE_SCENARIO.aimockFixtures);
  });
});
