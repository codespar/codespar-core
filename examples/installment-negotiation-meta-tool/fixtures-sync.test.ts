...
import { INSTALLMENT_NEGOTIATION_SCENARIO } from "@codespar/types/testing";
...
describe("aimock fixtures stay in sync with the published scenario", () => {
  it("static fixtures equal INSTALLMENT_NEGOTIATION_SCENARIO.aimockFixtures", () => {
    expect(staticFixtures).toEqual(INSTALLMENT_NEGOTIATION_SCENARIO.aimockFixtures);
  });
});
