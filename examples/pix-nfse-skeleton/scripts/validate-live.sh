...
# spawn with `--demo` so no Asaas / Nuvem-Fiscal credentials are needed.
...
#                                       servers will try real Asaas / Nuvem
...
# or anything that affects the LATAM-commerce system prompt or fixture
...
if command -v docker >/dev/null 2>&1; then
  CONTAINER_NAME="codespar-skeleton-live-$$"
  RUNTIME_LOG="$SKELETON_DIR/.runtime.log"
