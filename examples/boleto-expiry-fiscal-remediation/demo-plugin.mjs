...
//
// Registers `codespar_payment_status`, `codespar_invoice`, `codespar_notify`,
// and `codespar_pay` as meta-tools on the runtime via the MetaToolHook seam,
// using the shared definitions published from @codespar/types. Loaded by the
// runtime through CODESPAR_PLUGINS. The core ships no built-in meta-tools; the
// demo opts in.
//
